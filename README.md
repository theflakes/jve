...
```
### Example of Unique fields output
```
cat output.json | jve -u

ads,1,array[none],1
binary,1,object,1
binary.binary_info,1,object,1
binary.binary_info.arch,1,string,1
binary.binary_info.elf_info,1,object,1
binary.binary_info.elf_info.abi_version,1,number,1
binary.binary_info.elf_info.file_type,1,string,1
binary.binary_info.elf_info.object_version,1,number,1
binary.binary_info.elf_info.os_abi,1,string,1
binary.binary_info.entry_point,1,string,1
binary.binary_info.format,1,string,1
binary.binary_info.is_64,1,boolean,1
binary.binary_info.is_dotnet,1,boolean,1
binary.binary_info.is_lib,1,boolean,1
binary.binary_info.macho_info,1,object,1
binary.binary_info.macho_info.cpu_subtype,1,string,1
binary.binary_info.macho_info.file_type,1,string,1
binary.binary_info.macho_info.flags,1,string,1
binary.binary_info.macho_info.ncmds,1,number,1
binary.binary_info.macho_info.sizeofcmds,1,number,1
binary.binary_info.pe_info,1,object,1
binary.binary_info.pe_info.company_name,1,string,1
binary.binary_info.pe_info.file_description,1,string,1
binary.binary_info.pe_info.file_version,1,string,1
binary.binary_info.pe_info.internal_name,1,string,1
binary.binary_info.pe_info.legal_copyright,1,string,1
binary.binary_info.pe_info.linker,1,object,1
binary.binary_info.pe_info.linker.major_version,1,number,1
binary.binary_info.pe_info.linker.minor_version,1,number,1
binary.binary_info.pe_info.original_filename,1,string,1
binary.binary_info.pe_info.product_name,1,string,1
binary.binary_info.pe_info.product_version,1,string,1
binary.binary_info.pe_info.timestamps,1,object,1
binary.binary_info.pe_info.timestamps.compile,1,string,1
binary.binary_info.pe_info.timestamps.debug,1,string,1
binary.exports,1,object,1
binary.exports.count,1,number,1
binary.exports.hashes,1,object,1
binary.exports.hashes.md5,1,string,1
binary.exports.hashes.md5_sorted,1,string,1
binary.exports.hashes.ssdeep,1,string,1
binary.exports.hashes.ssdeep_sorted,1,string,1
binary.exports.names,1,array[none],1
binary.imports,1,object,1
binary.imports.func_count,1,number,1
binary.imports.hashes,1,object,1
binary.imports.hashes.md5,1,string,1
binary.imports.hashes.md5_sorted,1,string,1
binary.imports.hashes.ssdeep,1,string,1
binary.imports.hashes.ssdeep_sorted,1,string,1
binary.imports.imports,1,array[none],1
binary.imports.lib_count,1,number,1
binary.sections,1,object,1
binary.sections.sections,28,array[object],1,object,27
binary.sections.sections.elf_comment_or_note_content,27,null,21,string,6
binary.sections.sections.entropy,27,number,27
binary.sections.sections.md5,27,string,27
binary.sections.sections.name,27,string,27
binary.sections.sections.raw_size,27,number,27
binary.sections.sections.ssdeep,27,string,27
binary.sections.sections.virt_address,27,string,27
binary.sections.sections.virt_size,27,number,27
binary.sections.total_raw_bytes,1,number,1
binary.sections.total_sections,1,number,1
binary.sections.total_virt_bytes,1,number,1
bytes,1,number,1
directory,1,string,1
entropy,1,number,1
extension,1,string,1
filename,1,string,1
hashes,1,object,1
hashes.md5,1,string,1
hashes.sha1,1,string,1
hashes.sha256,1,string,1
hashes.ssdeep,1,string,1
is_hidden,1,boolean,1
is_link,1,boolean,1
link,1,object,1
link.abs_path,1,string,1
link.arguments,1,string,1
link.comment,1,string,1
link.flags,1,string,1
link.hotkey,1,string,1
link.icon_location,1,string,1
link.rel_path,1,string,1
link.show_command,1,string,1
link.working_dir,1,string,1
mime_type,1,string,1
path,1,string,1
runtime_env,1,object,1
runtime_env.device_type,1,string,1
runtime_env.run_as_admin,1,boolean,1
runtime_env.timestamp,1,string,1
strings,1,array[none],1
timestamps,1,object,1
timestamps.access_fn,1,string,1
timestamps.access_si,1,string,1
timestamps.create_fn,1,string,1
timestamps.create_si,1,string,1
timestamps.mft_record,1,string,1
timestamps.modify_fn,1,string,1
timestamps.modify_si,1,string,1
```
### Example output
```
